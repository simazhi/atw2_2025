...
*  [Formele semantiek en pragmatiek]{.alert2} (17/11)
    *  Grammaticale semantiek (zinsbetekenis)
    *  Logica
    *  Pragmatiek + sociolinguïstiek
*  [Sociolinguïstiek en Cognitief-functionele semantiek]{.alert2} (24/11)
    *  Focus op conceptuele betekenis
    *  Semantische extensies: metafoor en metonymie
*  [Computationele semantiek]{.alert2} (1/12) [Tim Van De Cruys]
*  [Cognitief-functionele semantiek]{.alert2} (8/12) 
    * Pragmatiektalk: Line Winkelmans over *allez*
    * Aspect
*  [Afsluiter + openstaande vragen]{.alert2} (15/12) 
    * Pragmatiektalk: Kaat De Gueldre over taalbeleid
    * Afsluiter + vragen
